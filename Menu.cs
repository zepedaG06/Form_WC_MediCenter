...
namespace MEDICENTER
{
    public class Menu
    {
        ...
        // Registro de nuevo personal medico por un administrador.
        // Esta funcion se invoca desde el menu de Personal y desde el menu de Administrador.
        ...
        private void MenuAdministrador(PersonalHospitalario admin)
        {
            ...
            do
            {
                ...
                Console.WriteLine("╚════════════════════════════════════════════════════╝");
                Console.WriteLine("\n  1. Ver Estadisticas del Hospital");
                Console.WriteLine("  2. Cambiar Contraseña (mi usuario)");
                Console.WriteLine("  3. Registrar nuevo personal medico");
                Console.WriteLine("  4. Ver mi informacion");
                Console.WriteLine("  5. Gestionar/Ver personal del hospital");
                Console.WriteLine("  6. Ver informacion de pacientes y doctores");
                Console.WriteLine("  7. Ver registros medicos del hospital");
                Console.WriteLine("  8. Ver cola de pacientes");
                Console.WriteLine("  0. Cerrar sesion");
                Console.Write("\n  Opcion: ");
                ...
                {
                    case "1":
                        // Puede ver estadisticas de los hospitales
                    ...
                    case "2":
                        ...
                        break;
                    case "3":
                        // Registra nuevo personal medico como administrador
                        RegistrarPersonalPorAdmin();
                        break;
                    case "4":
                        // Ver informacion del propio administrador
                        admin.MostrarInformacion();
                        Console.ReadKey();
                        break;
                    case "5":
                        // Gestionar/ver personal del hospital actual
                        GestionarPersonalHospital(admin);
                        break;
                    case "6":
                        // Nueva opcion: ver informacion global de pacientes y doctores
                        VerInformacionPacientesYDoctores();
                        break;
                    case "7":
        ...
        // Muestra informacion general de pacientes y doctores para el administrador.
        private void VerInformacionPacientesYDoctores()
        {
            ...
            while (!salir)
            {
                Console.Clear();
                Console.WriteLine("\n╔════════════════════════════════════════════════════╗");
                Console.WriteLine("║       INFORMACION DE PACIENTES Y DOCTORES          ║");
                Console.WriteLine("╚════════════════════════════════════════════════════╝");
                Console.WriteLine("\n  1. Ver todos los pacientes");
                Console.WriteLine("  2. Ver todo el personal medico");
                Console.WriteLine("  0. Volver");
                Console.Write("\n  Opcion: ");
        ...
        private void MostrarListadoPacientes()
        {
            Console.Clear();
            Console.WriteLine("\n╔════════════════════════════════════════════════════╗");
            ...
            foreach (var paciente in sistema.Pacientes)
            {
                Console.WriteLine($"\n  [{paciente.Id}] {paciente.Nombre} - {paciente.Email}");
                Console.WriteLine($"     Edad: {paciente.Edad} | Genero: {paciente.Genero} | Registros: {paciente.Historial.Count}");
            }
        ...
        private void MostrarListadoDoctores()
        {
            Console.Clear();
            Console.WriteLine("\n╔════════════════════════════════════════════════════╗");
            Console.WriteLine("║              LISTADO DE PERSONAL MEDICO            ║");
            Console.WriteLine("╚════════════════════════════════════════════════════╝");
            ...
            foreach (var p in sistema.Personal)
            {
                ...
                Console.WriteLine($"     Nivel: {p.NivelAcceso} | Hospital: {p.IdHospital} | Pacientes asignados: {p.PacientesAsignados.Count}");
            }
