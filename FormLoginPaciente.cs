...
namespace MEDICENTER
{
    public partial class FormLoginPaciente : Form
    {
        ...
        private void CrearTabLogin(TabPage tab)
        {
            ...
            // PictureBox para logo del login de paciente
        ...
        private void CrearTabRegistro(TabPage tab)
        {
            ...
            // PictureBox para logo en registro de paciente
            ...
            // PictureBox para imagen del seguro (dos espacios)
            PictureBox picSeguro1 = new PictureBox();
            ...
            PictureBox picSeguro2 = new PictureBox();
            ...
            btnImagenAqui.Location = new Point(230, yPos + 110);
            btnImagenAqui.Size = new Size(120, 30);
            btnImagenAqui.Click += (s, e) =>
            {
                using (OpenFileDialog ofd = new OpenFileDialog())
                {
                    ...
                    if (ofd.ShowDialog() == DialogResult.OK)
                    {
                        try
                        {
                            ...
                            picSeguro1.Image = img;
                            picSeguro2.Image = (Image)img.Clone();
                        }
                        catch (Exception)
                        {
