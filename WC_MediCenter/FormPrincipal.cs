...
namespace MEDICENTER
{
    public partial class FormPrincipal : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            Panel imgPaciente = new Panel();
            imgPaciente.Location = new Point(75, 30);
            imgPaciente.Size = new Size(150, 150);
            imgPaciente.BackColor = Color.FromArgb(100, 180, 220);
            panelPaciente.Controls.Add(imgPaciente);
            ...
            imgPaciente.Click += (s, e) => AbrirLoginPaciente();
            ...
            Panel imgPersonal = new Panel();
            imgPersonal.Location = new Point(75, 30);
            imgPersonal.Size = new Size(150, 150);
            imgPersonal.BackColor = Color.FromArgb(220, 100, 100);
            panelPersonal.Controls.Add(imgPersonal);
            ...
            imgPersonal.Click += (s, e) => AbrirLoginPersonal();
